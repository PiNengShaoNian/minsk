...
namespace Minsk.CodeAnalysis.Syntax
{
    sealed internal class Parser
    {
        ...
        private StatementSyntax ParseReturnStatement()
        {
            ...
            var sameLine = keywordLine == currentLine && !isEOF;
        ...
        private StatementSyntax ParseDoWhileStatement()
        {
            ...
            return new DoWhileStatementSyntax(_syntaxTree, doKeyword, statement, whileKeyword, condition);
        }
        ...
        private TypeClauseSyntax ParseTypeClause()
        {
            ...
            return new TypeClauseSyntax(_syntaxTree, colonToken, identifierToken);
        }
        ...
        public Parser(SyntaxTree syntaxTree)
        {
            ...
            do
            {
                ...
                if (token.Kind != SyntaxKind.WhitespaceToken && token.Kind != SyntaxKind.SingleLineCommentToken && token.Kind != SyntaxKind.MultiLineCommentToken && token.Kind != SyntaxKind.BadToken)
                {
                    tokens.Add(token);
                }
