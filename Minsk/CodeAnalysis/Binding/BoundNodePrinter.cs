...
namespace Minsk.CodeAnalysis.Binding
{
    internal static class BoundNodePrinter
    {
        ...
        private static void WriteNestedExpression(this IndentedTextWriter writer, int parentPrecedence, int precedence, BoundExpression expression)
        {
            var needsParenthesis = parentPrecedence >= precedence;
            if (needsParenthesis)
